        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p>
                Compliance Simplified ("we," "our," or "us") is committed to protecting your privacy and ensuring the security of your personal information. 
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                <li><strong>Contact Information:</strong> Name, email address, and organization when you contact us or subscribe to updates</li>
                <li><strong>Feedback and Contributions:</strong> Comments, suggestions, and contributions to our documentation</li>
                <li><strong>Communication:</strong> Messages you send to us through contact forms or email</li>
              </ul>
              ...
              <ul className="list-disc pl-6 mb-4">
                ...
                <li><strong>Cookies and Similar Technologies:</strong> Essential cookies for site functionality</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                <li><strong>Service Provision:</strong> To provide and maintain our compliance documentation and resources</li>
                <li><strong>Communication:</strong> To respond to your inquiries and provide support</li>
                <li><strong>Improvement:</strong> To analyze usage patterns and improve our content and services</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                ...
                <li><strong>Service Providers:</strong> With trusted third-party service providers who assist in operating our website (under strict confidentiality agreements)</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                <li><strong>Encryption:</strong> Data transmission is encrypted using industry-standard protocols (HTTPS/TLS)</li>
                <li><strong>Access Controls:</strong> Strict access controls and authentication mechanisms</li>
                <li><strong>Regular Audits:</strong> Periodic security assessments and vulnerability testing</li>
                <li><strong>Employee Training:</strong> Regular security awareness training for personnel</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                <li><strong>Active Users:</strong> Information is retained while you actively use our services</li>
                <li><strong>Legal Requirements:</strong> Longer retention periods may apply to comply with legal obligations</li>
                <li><strong>Security:</strong> Log data may be retained for security and audit purposes</li>
                <li><strong>Deletion:</strong> You may request deletion of your personal information (see Section 8)</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>We use essential cookies to ensure proper website functionality:</p>
              <ul className="list-disc pl-6 mb-4">
                ...
                <li><strong>No Third-Party Tracking:</strong> We do not use third-party advertising or tracking cookies</li>
              </ul>
            ...
            <section className="mb-8">
              ...
              <p>Our services are hosted in secure data centers. If you are located outside our hosting region, your information may be transferred to and processed in countries with different data protection laws. We ensure appropriate safeguards are in place for such transfers.</p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted/30 p-4 rounded-lg mt-4">
                ...
                <p><strong>GitHub Issues:</strong> <a href="https://github.com/arvid-berndtsson/compliance-simplified/issues" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80">Report Privacy Concerns</a></p>
                <p><strong>Data Protection Officer:</strong> Arvid Berndtsson</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">13. Compliance Framework Alignment</h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link href="/privacy" className="text-foreground font-medium">Privacy Policy</Link></li>
