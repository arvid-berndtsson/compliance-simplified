        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p>
                By accessing and using Compliance Simplified ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. 
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                <li><strong>Educational Content:</strong> Documentation, guides, and resources for ISO 27001 and SOC 2 compliance</li>
                <li><strong>Open Source Software:</strong> Code and tools available under AGPL-3.0 license</li>
                <li><strong>Community Platform:</strong> Forums and collaboration spaces for compliance professionals</li>
                <li><strong>Support Services:</strong> Technical assistance and guidance</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>When creating an account or using our services, you agree to:</p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">3.2 Acceptable Use</h3>
            ...
            <section className="mb-8">
              ...
              <p>The Service and its original content, features, and functionality are owned by Compliance Simplified and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.</p>
              
              <h3 className="text-xl font-semibold text-foreground mb-3">4.2 Open Source License</h3>
              <p>Our software is licensed under the GNU Affero General Public License v3.0 (AGPL-3.0). This means:</p>
              <ul className="list-disc pl-6 mb-4">
                <li>You can use, modify, and distribute our software</li>
                <li>You must share your modifications under the same license</li>
                <li>If you run the software on a server, you must provide source code access</li>
                <li>You must preserve copyright notices and license information</li>
              </ul>

              <h3 className="text-xl font-semibold text-foreground mb-3">4.3 User Contributions</h3>
              <p>By contributing content to our platform, you:</p>
              <ul className="list-disc pl-6 mb-4">
                <li>Grant us a non-exclusive, worldwide license to use your contributions</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mb-4">
                <li>Protecting your personal information in accordance with applicable laws</li>
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">6.1 Service Availability</h3>
              <p>We strive to maintain high availability but cannot guarantee uninterrupted access. The Service is provided "as is" without warranties of any kind.</p>
              
              <h3 className="text-xl font-semibold text-foreground mb-3">6.2 Compliance Guidance</h3>
              <p>Our content is for educational purposes only and does not constitute:</p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <p>To the maximum extent permitted by law, Compliance Simplified shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of the Service.</p>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">7. Security and Compliance</h2>
              <p>We implement security measures aligned with industry standards:</p>
              <ul className="list-disc pl-6 mb-4">
                <li><strong>Data Protection:</strong> Encryption, access controls, and security monitoring</li>
                <li><strong>Regular Audits:</strong> Security assessments and vulnerability testing</li>
                <li><strong>Incident Response:</strong> Procedures for handling security incidents</li>
                <li><strong>Compliance Monitoring:</strong> Ongoing review of security practices</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>These Terms shall be governed by and construed in accordance with the laws of the jurisdiction where Compliance Simplified operates, without regard to conflict of law principles.</p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted/30 p-4 rounded-lg mt-4">
                <p><strong>Email:</strong> <a href="mailto:arvid@arvid.tech" className="text-primary hover:text-primary/80">arvid@arvid.tech</a></p>
                <p><strong>GitHub Issues:</strong> <a href="https://github.com/arvid-berndtsson/compliance-simplified/issues" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80">Report Issues</a></p>
                <p><strong>Legal Inquiries:</strong> For legal matters, please include "Legal" in the subject line</p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-foreground mb-4">12. Compliance Framework Alignment</h2>
              <p>These Terms of Service are designed to support compliance with:</p>
              <ul className="list-disc pl-6 mb-4">
                <li><strong>SOC 2 Trust Services Criteria:</strong> Security, Availability, Processing Integrity, Confidentiality, and Privacy</li>
                ...
                <li><strong>Industry Standards:</strong> Best practices for online services</li>
              </ul>
            </section>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/terms" className="text-foreground font-medium">Terms of Service</Link></li>
