          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We believe that compliance knowledge should be open, transparent, and accessible to everyone. 
                Our mission is to break down the barriers that prevent organizations from implementing proper security practices.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Democratize Knowledge</h3>
                <p className="text-muted-foreground">
                  Make compliance guidance available to organizations of all sizes, not just those who can afford expensive consultants.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Help organizations build trust with their customers through demonstrable security practices and compliance.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-2">Foster Community</h3>
                <p className="text-muted-foreground">
                  Create a collaborative environment where security professionals can share knowledge and best practices.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We chose the GNU Affero General Public License v3.0 (AGPL-3.0) to ensure that our work remains free and open, 
                and that improvements benefit the entire community.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-card p-8 rounded-lg border border-border/50">
                <h3 className="text-xl font-semibold text-foreground mb-4">What AGPL-3.0 Means</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3">
                    ...
                    <span>You can use, share, and modify this software for any purpose</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="h-5 w-5 text-green-500 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>If you modify and run it on a server, you must share the source code</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-card p-8 rounded-lg border border-border/50">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <div>
                    ...
                    <p>Ensures that compliance knowledge remains transparent and accessible to all organizations.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Community Benefit</h4>
                    <p>Any improvements made by the community must be shared back, benefiting everyone.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Prevents Lock-in</h4>
                    <p>Prevents any single organization from creating proprietary versions that lock others out.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-foreground mb-2">Network Effect</h4>
                    <p>The "network use" clause ensures that web-based versions remain open source.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                This project is made possible by the contributions of security professionals, compliance experts, 
                and organizations committed to making security accessible to all.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-card p-6 rounded-lg border border-border/50 text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-1">Community Contributors</h3>
                <p className="text-sm text-muted-foreground mb-3">Security Professionals</p>
                <p className="text-sm text-muted-foreground">
                  Security experts, compliance professionals, and organizations who contribute their knowledge and experience.
                </p>
              </div>
              ...
              <div className="bg-card p-6 rounded-lg border border-border/50 text-center">
                ...
                <h3 className="text-lg font-semibold text-foreground mb-1">Open Source Community</h3>
                <p className="text-sm text-muted-foreground mb-3">Developers & Maintainers</p>
                <p className="text-sm text-muted-foreground">
                  The broader open source community that builds and maintains the tools and frameworks we use.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              We welcome contributions from security professionals, compliance experts, and anyone passionate about making security accessible.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link href="/about" className="text-foreground font-medium">About</Link></li>
              </ul>
            </div>
